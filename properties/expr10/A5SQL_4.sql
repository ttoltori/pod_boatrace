...
--select 'result_type', 'grade_type', 'bettype', 'kumiban', 'simul_patternid', 'term_1', 'term_2', 'factor', 'factormin', 'modelno', 'group_sql_id', 'i0'
--union
---------------------------------------------------------------------------------------------
copy (
(select
...
-- 77_12, 77_R占쎈쐻占쎈윥占쎈㎍占쎈쐻占쎈윥占쎌몗占쎈쐻占쎈윥占쎈윫占쎈쐻占쎈윥占쎈㎍占쎈쐻占쎈윥占쎌몗占쎈쐻占쎈윪筌띿룞�삕占쎌맶�뜝�럥�쑅�뜝�럥彛℡뜝�럥夷у뜝�럥利띰옙�빝雅뚯돀0,1,2占쎈쐻占쎈윥占쎈㎍占쎈쐻占쎈윥占쎌몗占쎈쐻占쎈윥占쎈윫占쎈쐻占쎈윥占쎈㎍占쎈쐻占쎈윥占쎌몗占쎈쐻占쎈윪筌륁�λ쐻占쎈윥占쎈㎍占쎈쐻占쎈윥占쎌몗占쎈쐻占쎈윞占쎈뼃畑띕끂理먬뜮占썲뜝�럩援꿰솾�꺂�뒧占쎈�뺝뜝�럥�맜�뜝�럥���윜諛잙쳛占쎄뎡占쎈쐻占쎈윪筌띾씛�삕占쎌맶�뜝�럥�쑅�뜝�럥�걞占쎈쐻占쎈윥占쎌넇占쎈쐻占쎈윪占쎈２�뜝�럥�맶�뜝�럥吏쀥뜝�럩援꿨뜝�럥夷⑨옙�쐻占쎈쑕占쎌맶�뜝�럥�쑋占쎈쨨占쎈Ŋ�굲�뜝�럩�읁占쎈쐻占쎈윥筌앸떦異��뜝�룞�삕占쎈뮲�뜝�럩援뀐옙�쐻占쎈윞占쎈젇�궘占쏙옙�걝占쎈뤁�뜝�럩援꿨뜝�럥�맶�뜝�럥�쑋�뜝�럥痢ο옙�쐻占쎈윪占쎌읆癲ル슢�뀖占쎈뮝�뜝�럡�렊�뜝�럥�맶�뜝�럥�쑋嶺뚮씭�뵛占쎌굲�뜝�럩留띰옙�쐻占쎈윥占쎌몗占쎈쐻占쎈윪筌띿뜴�쐻占쎈윥占쎈㎍占쎈쐻占쎈윥占쎌몗占쎈쐻占쎈윪筌륁빆�쐻占쎈윥占쎈㎍占쎈쐻占쎈윥占쎌몗占쎈쐻占쎈윥占쎈윫占쎈쐻占쎈윥占쎈㎍占쎈쐻占쎈윥占쎌몗占쎈쐻占쎈윪筌륁�λ쐻占쎈윥占쎈읁�뜝�럥�맶�뜝�럥吏쀥뜝�럩援뀐옙�쐻占쎈윪占쎈뮲�뜝�럩援뀐옙�쐻占쎈윥占쎈윫占쎈쐻占쎈윥占쎈㎍占쎈쐻占쎈윥占쎌몗占쎈쐻占쎈윪筌륁�λ쐻占쎈윥占쎈㎍占쎈쐻占쎈윥占쎌몗�뜝�럩�쟼占쎈쐻�뜝占� 2023/6/22
select 
 *
from
  (	select 
...
-- simulation占쎈쐻占쎈윥占쎈㎍占쎈쐻占쎈윥占쎌몗占쎈쐻占쎈윥占쎈윫占쎈쐻占쎈윥占쎈㎍占쎈쐻占쎈윥占쎌몗占쎈쐻占쎈윪筌륁�λ쐻占쎈윥占쎈㎍占쎈쐻占쎈윥占쎌몗占쎈쐻占쎈윥占쎌몞
...
-- ml_evaluation�뜝�럥�맶�뜝�럥�쑅�뜝�럥�럪�뜝�럥�맶�뜝�럥�쑅�뜝�럩紐쀥뜝�럥�맶�뜝�럥�쑅�뜝�럥�쑌�뜝�럥�맶�뜝�럥�쑅�뜝�럥�럪�뜝�럥�맶�뜝�럥�쑅�뜝�럩紐쀥뜝�럥�맶�뜝�럥�쑋嶺뚮씮猷욑옙�굲�뜝�럩留띰옙�쐻占쎈윥占쎌몗�뜝�럩�쟼占쎈쐻占쎈짗占쎈돗�뜝�럩�뮛�뜝�룞�삕癲딅냲�삕占쎈쐻占쎈쑕占쎌맶�뜝�럥�쑅�뜝�럥�쑌�뜝�럥�맶�뜝�럥�쑅�뜝�럥�럪�뜝�럥�맶�뜝�럥�쑅�뜝�럩紐쀥뜝�럥�맶�뜝�럥�쑋嶺뚮씮猷욑옙�굲�뜝�럩留띰옙�쐻占쎈윥占쎌몗�땱�떜利얕린洹⑥삕占쎈㎍占쎈쐻占쎈윥占쎌몗傭��끉猷뉗㏏�뜝�럩留띰옙�쐻占쎈윥占쎌몝癲ル슢�뵯占쎈탿�뜝�럩援뀐옙�쐻占쎈윪筌띾씛�삕占쎌맶�뜝�럥�쑅�뜝�럩紐쀧솾�꺂�뒩占쎈뤅占쎈쐻占쎈뼢占쎄땀筌띾씛�삕占쎌맶�뜝�럥�쑅�뜝�럩紐앾옙�쐻占쎈윥鸚룐뫅�삕占쎌맶占쎈쐻�뜝占�
...
-- ml_evaluation占쎈쐻占쎈윥占쎈㎍占쎈쐻占쎈윥占쎌몗占쎈쐻占쎈윥占쎈윫占쎈쐻占쎈윥占쎈㎍占쎈쐻占쎈윥占쎌몗占쎈쐻占쎈윪筌륁�λ쐻占쎈윥占쎈㎍占쎈쐻占쎈윥占쎌몗占쎈쐻占쎈윥占쎌몞
drop table sim_eval;
-- SG_1T_*-*-*_wk12+jyo+race_i09-100_0_79100_JSJ-S2_77_12_10150
create table sim_eval as 
select 
