...
BEGIN
    ...
    select 
      slope.description, slope.bettype, slope.kumiban, slope.pattern_name, 
    ...
    where slope.description = bias.description and slope.bettype = bias.bettype and slope.kumiban = bias.kumiban and slope.pattern_name = bias.pattern_name
      and slope.description = recover.description and slope.bettype = recover.bettype and slope.kumiban = recover.kumiban and slope.pattern_name = recover.pattern_name;
END
$$ LANGUAGE plpgsql;
