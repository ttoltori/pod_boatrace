...
public class ModelBatchCreator {

	Logger logger = LoggerFactory.getLogger(ModelBatchCreator.class);
	
	public ModelBatchCreator() {
	}
	...
	public void create(String defFileDir, String executeFileName, String defName, String fromYmd, String toYmd1, String toYmd2, int interval) throws Exception{
		...
		while(dateToYmd1.isBefore(dateToYmd2)) {
			...
			String modelFileFullpath = defFileDir + "/model_release/" + defName + "_" + fromYmd + "_" + endYmd + ".model";
...
//		};
		...
		ModelBatchCreator ac = new ModelBatchCreator();
		try {
			String dir = args[0];
