	...
	private void loadDB() throws Exception {
		...
		try (SqlSession session = sqlSessionFactory.openSession(false)) {
			...
			for (DBRecord rec : results) {
				mapPattern.addItem(rec.getString("pattern"), rec);
			}
		}
	}
...
//		String defFilepath = "C:/Dev/workspace/Oxygen/pod_boatrace_test/experiment/expr02/0012_rank_turn+racetype_entry.def";
