 ...
 *
 */
public class EvaluationSimulLoaderFPI7 extends AbstractEvaluationLoader {
	/** sql template */
	...
	void loadDB() throws Exception {
		...
		try {
			...
			//String customSql = "patternid like '" + custom + "'";
			...
			sql = sql.replace("{models}", StringUtil.quote(modelsToken));
	...
	public static void main(String[] args) {
		...
		try {
			...
			List<Evaluation> evals = new EvaluationSimulLoaderFPI7().getEvaluations();
