 ...
 *
 */
public class EvaluationSimulLoaderFPI5GraphFilename extends AbstractEvaluationLoader {
	...
	public static void main(String[] args) {
		...
		try {
			...
			List<Evaluation> evals = new EvaluationSimulLoaderFPI5GraphFilename().getEvaluations();
