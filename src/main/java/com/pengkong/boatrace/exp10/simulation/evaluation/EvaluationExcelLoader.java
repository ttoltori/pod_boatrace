 ...
 *
 */
public class EvaluationExcelLoader extends AbstractEvaluationLoader {
	/** group定義DBロード */
	@Override
	...
	void loadExcel() throws Exception {
		...
		String filepath = prop.getString("file_evaluations");
...
//				prop.getString("bonus_bor"), prop.getString("bonus_bork"), prop.getString("bonus_borkbor"));
	...
	public static void main(String[] args) {
		...
		try {
			...
			List<Evaluation> evals = new EvaluationExcelLoader().getEvaluations();
