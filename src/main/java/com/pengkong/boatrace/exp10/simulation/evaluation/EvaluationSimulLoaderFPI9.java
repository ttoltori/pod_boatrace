 ...
 *
 */
public class EvaluationSimulLoaderFPI9 extends AbstractEvaluationLoader {
	/** sql template */
	...
	void loadDB() throws Exception {
		...
		try {
			...
			sql = sql.replace("{pattern}", prop.getString("pattern"));
	...
	public static void main(String[] args) {
		...
		try {
			...
			List<Evaluation> evals = new EvaluationSimulLoaderFPI9().getEvaluations();
