...
/**
 * EvaluationSimulLoaderBIG3とEvaluationSimulLoaderVICが内容同一のため
 * これに統合して使う 2023/11/19
 * 
 * @author ttolt
 *
 */
public class EvaluationSimulLoaderBV extends AbstractEvaluationLoader {
	/** sql template */
	...
	public static void main(String[] args) {
		...
		try {
			...
			List<Evaluation> evals = new EvaluationSimulLoaderBV().getEvaluations();
