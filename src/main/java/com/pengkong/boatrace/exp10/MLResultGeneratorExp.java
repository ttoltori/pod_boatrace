 ...
 *
 */
public class MLResultGeneratorExp {
	...
	/** result生成クラス */
	AbstractResultCreatorExp resultCreator;
	
	String configProperty;
	
	public MLResultGeneratorExp()  {
	}
	...
	void setupResultCreator() throws Exception {
		...
		resultCreator = (AbstractResultCreatorExp) c.newInstance();
	}
...
//						mapperPrEval.insert(prRec);
	...
	List<MlResult> createResult(DBRecord rec, AbstractResultCreatorExp resultCreator) throws Exception {
	...
	*/	
	...
	public static void main(String[] args) {
		...
		try {
			...
			MLResultGeneratorExp generator = new MLResultGeneratorExp();
