 ...
 *
 */
public class BoddsProbabilityBetcntBubble extends AbstractDoubleRangeBubbleChart {
	Logger logger = LoggerFactory.getLogger(BoddsProbabilityBetcntBubble.class);

	public BoddsProbabilityBetcntBubble(ResultStat stat) {
		super(stat);
	...
	protected String createTitleLabel() {
		...
		String label;
		label = "Bodds/Prob betcnt(" + dto.getBorBestmin() + "～" + dto.getBorBestmax() + " / " + dto.getPrBestmin() + "～"
				+ dto.getPrBestmax() + ")  ";
