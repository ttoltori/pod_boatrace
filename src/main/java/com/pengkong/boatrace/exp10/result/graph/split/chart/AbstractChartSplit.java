...
public abstract class AbstractChartSplit {
	protected Logger logger = LoggerFactory.getLogger(AbstractChartSplit.class);
	...
	protected List<ResultStat> statSplit;
	...
	protected Color[] colors = {Color.BLACK,  Color.BLUE, Color.RED, Color.MAGENTA, Color.GREEN, Color.ORANGE};
	
	public AbstractChartSplit(ResultStat stat, List<ResultStat> statSplit) {
		super();
		this.stat = stat;
