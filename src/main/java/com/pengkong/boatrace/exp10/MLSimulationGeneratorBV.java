...
// EvaluationSimulLoaderVICとEvaluationSimulLoaderBIGが同じであるので統合する。
public class MLSimulationGeneratorBV extends MLResultGenerator {
	/** simulation結果生成クラス */
	...
	public MLSimulationGeneratorBV() {
		super();
	}
...
//		String exNoList = "1";
		...
		try {
			...
			MLSimulationGeneratorBV generator = new MLSimulationGeneratorBV();
