...
public class MLPropertyUtil extends PropertyUtil {
	//MLReportUtil report = MLReportUtil.getInstance();
	Logger logger = LoggerFactory.getLogger(MLPropertyUtil.class);
	...
	public static MLPropertyUtil getInstance() {
		return MLPropertyUtilInstanceHolder.INSTANCE;
	}
	
	public MLPropertyUtil() {
		super();
	}
