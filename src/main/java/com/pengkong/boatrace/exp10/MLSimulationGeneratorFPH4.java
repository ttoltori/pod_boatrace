...
public class MLSimulationGeneratorFPH4 extends MLResultGenerator {
	/** simulation結果生成クラス */
	...
	public MLSimulationGeneratorFPH4() {
		super();
	}
							...
							for (String resultEvalId : resultEvalIdToken) {
								for (String term : termToken) {
									...
									if (custom.equals("all")) {
										...
										prop.putProperty("custom", "patternid in ('wk1','wk12','wk123','wk1234')");
									}
...
//		String exNoList = "1";
		...
		try {
			...
			MLSimulationGeneratorFPH4 generator = new MLSimulationGeneratorFPH4();
