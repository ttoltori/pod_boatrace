...
public class MLSimulationGeneratorVIC extends MLResultGenerator {
	/** simulation結果生成クラス */
	...
	public MLSimulationGeneratorVIC() {
		super();
	}
...
//		String exNoList = "1";
		...
		try {
			...
			MLSimulationGeneratorVIC generator = new MLSimulationGeneratorVIC();
