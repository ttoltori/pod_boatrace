...
// EvaluationSimulLoaderVIC simul_VIC
public class Step2SimulationGenerator extends MLResultGenerator {
	/** simulation結果生成クラス */
	...
	public Step2SimulationGenerator() {
		super();
	}
	...
	void executeExperiment(String exNo) throws Exception {
        ...
        for (String gradeType : gradeTypeToken) {
            //for (String term : termToken) {
                ...
                String term = String.join("~", prop.getString("result_start_ymd"), prop.getString("result_end_ymd"));
...
//		String exNoList = "1";
		...
		try {
			...
			Step2SimulationGenerator generator = new Step2SimulationGenerator();
