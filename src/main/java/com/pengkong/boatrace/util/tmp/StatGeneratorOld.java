...
public class StatGeneratorOld {
	private Logger logger = LoggerFactory.getLogger(StatGeneratorOld.class);
...
//			new StatGenerator().execute(args[0], args[1]);
			...
			new StatGeneratorOld().execute("20160101", "20181007", "20181007");
