...
public class RecRace2Pattern {
	...
	public RecRace2Pattern(RecRace race) {
		this.jyocd = race.getJyocd();
		this.turn = race.getTurn();
		this.raceno = race.getRaceno().toString();
		this.racetype = race.getRacetype();
		this.alcount = race.getAlevelcount().toString();
		this.level = race.getWakulevellist();
		this.levelrank = race.getLevelrank();
		this.sime = race.getSime();
