...
public interface MlClassificationMapper {
	 ...
	 * @mbg.generated
	 */
	int updateByExampleSelective(@Param("record") MlClassification record,
			@Param("example") MlClassificationExample example);

	/**
	 * This method was generated by MyBatis Generator. This method corresponds to the database table public.ml_classification
	 * @mbg.generated
	 */
	int updateByExample(@Param("record") MlClassification record, @Param("example") MlClassificationExample example);
}