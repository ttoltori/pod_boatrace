-- kumibanl単位生成
DROP FUNCTION IF EXISTS s3a_generate_ranking(VARCHAR(20), int, VARCHAR(250), VARCHAR(200), int, VARCHAR(1), VARCHAR(2)[]); 
CREATE OR REPLACE FUNCTION s3a_generate_ranking(
