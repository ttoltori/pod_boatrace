-- kumibanl単位生成
DROP FUNCTION IF EXISTS ranking_555_wk(int, int, VARCHAR(40), VARCHAR(250), VARCHAR(200), VARCHAR(1), VARCHAR(2)[], VARCHAR(3)); 
CREATE OR REPLACE FUNCTION ranking_555_wk(
pFactorNo int,
pRanking int,
