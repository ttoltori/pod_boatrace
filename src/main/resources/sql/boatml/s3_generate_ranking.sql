-- kumibanl単位生成
DROP FUNCTION IF EXISTS s3_generate_ranking(VARCHAR(20), int, VARCHAR(250), VARCHAR(200), int, VARCHAR(1), VARCHAR(2)[], VARCHAR(3)); 
CREATE OR REPLACE FUNCTION s3_generate_ranking(
