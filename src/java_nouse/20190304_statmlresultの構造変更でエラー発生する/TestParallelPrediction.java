...
public class TestParallelPrediction {
	...
	public void initialize(String bettype, String bettypeName,String description, 
		...
		for (int i = 0; i < modelClassNames.length; i++) {
			...
			classifier.initialize(classVal, arrModelFile[i]);
			...
			while (currDate.compareTo(toDate) <= 0) {
				...
				if (listHashmapYmd != null) {
					...
					for (HashMap<String, ?> hashmap : listHashmapYmd) {
						...
						for (BoatClassifier boatClassifier : listClassifier) {
	...
	public static void main(String[] args) {
		try {
			...
			TestParallelPrediction classifier = new TestParallelPrediction();
			classifier.initialize(
					"2F", 
					"nirenhuku",
					"70_2F_12oddsrank1-4else_multi", 
					"", 
					...
					new String[] {
						...
						"com.pengkong.boatrace.weka.classifiers.BoatClassifier70_4",
						"com.pengkong.boatrace.weka.classifiers.BoatClassifier70_5",
						"com.pengkong.boatrace.weka.classifiers.BoatClassifier70_6"
					...
					new String[] {
							...
							"C:/Dev/workspace/Oxygen/pod_boatrace/test/wekamodels/70-5_2F_12oddsrank1-4else_BayesNet.model",
							"C:/Dev/workspace/Oxygen/pod_boatrace/test/wekamodels/70-6_2F_12oddsrank1-4else_BayesNet.model",
							// "C:/Dev/workspace/Oxygen/pod_boatrace/test/wekamodels/65-2_2T_12else_50000.AutoWeka.model",
							//"C:/Dev/workspace/Oxygen/pod_boatrace/test/wekamodels/65-3_2T_12else_50000.AutoWeka.model"
					}
			);
			
			classifier.execute("20170101", "20171231", null);
