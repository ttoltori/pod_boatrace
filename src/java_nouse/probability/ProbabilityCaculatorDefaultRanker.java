 ...
 *
 */
public class ProbabilityCaculatorDefaultRanker extends AbstractProbabilityCalculator {
	@Override
	...
	Double getProbability4T(DBRecord rec) {
		return rec.getDouble("probability1") * rec.getDouble("probability2") * rec.getDouble("probability3") * rec.getDouble("probability4");	
	}
}
